...
pattern = r'(\xa0)?'
base = 'https://www.bendigobank.com.au/api/articleListing/get-by-filter?page={}&bid=8709&totalPages=false&filters=%7B%22topic%22:%22-all-%22%7D&term='

class BbendigobankSpider(scrapy.Spider):
	name = 'bendigobank'
	page = 1
